...
public class DialogManager_ForcedLanding : MonoBehaviour, IPointerDownHandler
{
    ...
    public static DialogManager_ForcedLanding instance;
    ...
    public void NextSentence()
    {
        if (sentences.Count != 0)
        {
            ...
            if (i == 4)
            {
                image.GetComponent<Image>().sprite = Resources.Load("PrologueImage\\24", typeof(Sprite)) as Sprite;
            }
        }
        else
        {
