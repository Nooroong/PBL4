...
public class DialogManager_Toilet : MonoBehaviour, IPointerDownHandler
{
    ...
    public static DialogManager_Toilet instance;
    ...
    public void NextSentence()
    {
        if (sentences.Count != 0)
        {
            ...
            if (i == 4)
            {
                image.GetComponent<Image>().sprite = Resources.Load("PrologueImage\\6", typeof(Sprite)) as Sprite;
            }
        }
        else
        {
